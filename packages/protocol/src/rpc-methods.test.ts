...
const cases: [RpcMethod, unknown, boolean][] = [
  ...
  ['sessions.createHelp', { question: 'how do I pair?' }, true],
  ['sessions.createHelp', { question: '' }, false],
  ['sessions.createHelp', { question: 7 }, false],
  ['sessions.createHelp', {}, false],
  ...
  ['sessions.restart', { ...s, model: 'opus', effort: 'low' }, true],
  ['sessions.restart', { ...s, model: null, effort: null }, true],
  ['sessions.restart', { ...s, model: '' }, false],
  ['sessions.restart', { ...s, effort: 2 }, false],
  ['sessions.restart', { ...s, model: undefined }, true],
  ...
  ['settings.set', { agents: [{ name: 'reviewer', model: 'opus' }] }, true],
