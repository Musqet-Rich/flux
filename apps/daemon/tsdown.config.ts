...
// Two entries: `flux` (dist/index.mjs) and the MCP server the agent spawns per session
// (dist/flux-mcp.mjs; create-mcp-config.ts resolves it as a sibling of index.mjs). They are
