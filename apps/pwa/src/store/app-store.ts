...
// Components import this; tests build their own with createStore. Where push cannot work (the
// dev server registers no worker; a browser may lack push) the store gets no way to subscribe,
// so it never offers "Enable notifications".
