...
// The next message closes the turn: an ended task leaves the strip, its note in main still
// opens its chat, and while that chat is open its row is back (highlighted) for Back.
