...
// The session's own menu, in its toolbar: clear the agent's context, archive, or delete. No
// menu library: a button with `aria-haspopup="menu"` and a `role="menu"` list it shows.
// Archiving and deleting leave the session, so the parent is told to navigate away.
