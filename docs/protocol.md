...
| `agent.send`          | `{ session; text; commentIds?: string[]; replyTo?: number; attachments?: string[] }`                | `{ seq: number }` (`attachments` are ids from `attach.end`, each complete and the session's own, else `bad_params`; `too_large` when they total over 50 MiB; `conflict` when the session closed while the message was being prepared)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
